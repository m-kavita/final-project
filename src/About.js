        ...
        <div className='bg-gray-100'>
            <div className='card-header'>
                ...
                <div className="items-center absolute bottom-1/2 md:left-1/4 md:right-1/4 justify-center">
                    <h4 className="mb-3 text-3xl lg:text-8xl font-siteName break-normal text-center uppercase drop-shadow-lg text-primary-200">Our Story</h4>
